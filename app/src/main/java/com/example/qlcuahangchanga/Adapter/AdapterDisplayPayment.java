...
public class AdapterDisplayPayment extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(view == null){
            ...
            viewHolder.img_custompayment_HinhHang = (CircleImageView)view.findViewById(R.id.img_custompayment_HinhHang);
            viewHolder.txt_custompayment_TenHang  = (TextView)view.findViewById(R.id.txt_custompayment_TenHang);
        ...
        viewHolder.txt_custompayment_TenHang.setText(thanhToanDTO.getTenHang());
        ...
        viewHolder.img_custompayment_HinhHang.setImageBitmap(bitmap);

        return view;
    }

    public class ViewHolder{
        CircleImageView img_custompayment_HinhHang;
        TextView txt_custompayment_TenHang, txt_custompayment_SoLuong, txt_custompayment_GiaTien;
    }
}