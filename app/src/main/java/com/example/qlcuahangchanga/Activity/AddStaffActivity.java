...
public class AddStaffActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private boolean validateFullName(){
        ...
        if(val.isEmpty()){
            TXTL_addstaff_HoVaTen.setError("Không được để trống!");
            return false;
        }else {
    ...
    private boolean validateUserName(){
        ...
        if(val.isEmpty()){
            TXTL_addstaff_TenDN.setError("Không được để trống!");
            return false;
    ...
    private boolean validateEmail(){
        ...
        if(val.isEmpty()){
            TXTL_addstaff_Email.setError("Không được để trống");
            return false;
        }else if(!val.matches(checkspaces)){
    ...
    private boolean validatePhone(){
        ...
        if(val.isEmpty()){
            TXTL_addstaff_SDT.setError("Không được để trống");
            return false;
    ...
    private boolean validatePassWord(){
        ...
        if(val.isEmpty()){
            TXTL_addstaff_MatKhau.setError("Không được để trống!");
            return false;
