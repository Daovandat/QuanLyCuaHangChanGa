...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IMG_signup_back     = findViewById(R.id.img_signup_back);
        BTN_signup_next     = findViewById(R.id.btn_signup_next);
        TXT_signup_title    = findViewById(R.id.txt_signup_title);
    ...
    private boolean validateFullName(){
        ...
        if(val.isEmpty()){
            TXTL_signup_HoVaTen.setError("Không được để trống!");
            return false;
        }else {
    ...
    private boolean validateUserName(){
        ...
        if(val.isEmpty()){
            TXTL_signup_TenDN.setError("Không được để trống!");
            return false;
    ...
    private boolean validateEmail(){
        ...
        if(val.isEmpty()){
            TXTL_signup_Email.setError("Không được để trống!");
            return false;
        }else if(!val.matches(checkspaces)){
    ...
    private boolean validatePhone(){
        ...
        if(val.isEmpty()){
            TXTL_signup_SDT.setError("Không được để trống");
            return false;
    ...
    private boolean validatePassWord(){
        ...
        if(val.isEmpty()){
            TXTL_signup_MatKhau.setError("Không được để trống!");
            return false;
