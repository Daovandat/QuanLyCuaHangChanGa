...
import com.example.qlcuahangchanga.DAO.QuyenDAO;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BTN_signup_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ktra != 0){
                    Toast.makeText(Register2ndActivity.this,"Thêm thành công!",Toast.LENGTH_SHORT).show();
                    callLoginFromRegister();
                }else{
                    Toast.makeText(Register2ndActivity.this,"Thêm thất bại!",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
